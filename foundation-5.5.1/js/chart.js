$(function () {
    ...
    $('.chart1-small').highcharts(chartConfig);
    $('.chart2-small').highcharts(chartConfig);
    $('.chart3-small').highcharts(chartConfig);
    $('.chart4-small').highcharts(chartConfig);

    $('.chart1-medium').highcharts(chartConfig);
    $('.chart2-medium').highcharts(chartConfig);
    $('.chart3-medium').highcharts(chartConfig);

    $('.chart1-large').highcharts(chartConfig);
    $('.chart2-large').highcharts(chartConfig);

    $('.chart1-xlarge').highcharts(chartConfig);
});
